...
public class AdopcionDAO {
    ...
    public int crearAdopcion(Adopcion adopcion) {
        ...
        int resultado = jdbcTemplate.update(sqlcrear,adopcion.getID_Mascota(), adopcion.getID_Usuario(), "Solicitada");
        return resultado;
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //ELIMINAR ADOPCION
    ...
    public List<Adopcion> listarSolicitudAdopcion (int idUsuario){
        ...
        List<Adopcion> adopcionVista = jdbcTemplate.query(SQLconsulta, new Object[]{idUsuario}, new BeanPropertyRowMapper<>(Adopcion.class));
        return adopcionVista;
    }

    public int buscarAdopcion(int id) {
        String sqlcrear = "select ID_Usuario from Adopcion where id =?";
        int resultado = jdbcTemplate.queryForObject(sqlcrear, new Object[]{id}, Integer.class);
        return resultado;
    }
